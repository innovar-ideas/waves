...
export default function PerformanceReviewDetailsPage() {
  ...
  const templateMetrics = reviewAssignment?.template.metrics as unknown as performanceReviewTemplateMetricsType[];
        ...
        <div className="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          <div className="text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-600 dark:text-gray-400">The performance review you are looking for doesn not exist or has been deleted.</p>
            </div>
  ...
  const transformedData = reviewAssignment.team.designations.flatMap(designation => 
    designation.designation.teamDesignations.flatMap(teamDesignation => 
      teamDesignation.staffs.map(staff => ({
        ...
        team_name: reviewAssignment.team.name,
        staff: staff,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Review template and team information for {reviewAssignment.team.name}
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
                    {reviewAssignment.template.name}
                  </h3>
                ...
                <div>
                  ...
                  {reviewAssignment.team.parentTeam && (
                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-400 flex items-center gap-2">
                      ...
                      Parent Team: {reviewAssignment.team.parentTeam.name}
                    </p>
                  )}
                </div>
                <div className="grid grid-cols-2 gap-6">
                  <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                    ...
                    <p className="mt-2 text-2xl font-bold text-emerald-600 dark:text-emerald-400">
                      {reviewAssignment.team.designations.length}
                    </p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
