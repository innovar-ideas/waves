...
export default  function Dashboard() {
  ...
  // Fetch unread notificationss
  const {data: unreadNotifications} =  trpc.getUnreadNotificationCount.useQuery({
    ...
    <>
      <div className='flex items-center justify-between w-full'>
        <div className='flex items-center'>
          <h1 className='text-lg font-semibold md:text-2xl'>Hi, {session.data?.user.first_name} 👋🏽</h1>
        </div>
