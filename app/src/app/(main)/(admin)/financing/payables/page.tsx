...
import { billColumns, renderSubComponent } from "../bills/_components/bill-columns";
import { BILL_STATUSES } from "@/app/server/types";
...
export default function PayablesPage() {
  ...
  const { data } = trpc.getPayables.useQuery({ 
    organizationSlug,
  ...
  return (
    <div className="min-h-screen w-full space-y-6 rounded-lg bg-white p-6 shadow-lg">
      <div className="flex flex-col items-center space-y-4 md:flex-row md:justify-between">
        <h4 className="font-bold">Payables</h4>
      </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatAmountToNaira(data?.totalPayables || 0)}
            </div>
