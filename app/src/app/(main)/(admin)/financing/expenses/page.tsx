...
import NewExpenseAccountForm from "./_components/create-new-expenses";
import { PaymentForm } from "../_components/payment-form";

enum ViewType {
  Default = "default",
  CreateExpenseAccount = "createExpenseAccount",
  LoginExpense = "loginExpense",
}
...
export default function ExpensePage() {
  ...
  const { data } = trpc.getAllExpensesAccounts.useQuery({ 
  ...
  // const { data: sessions } = trpc.getTermSessionsForFinance.useQuery({
  //   organizationSlug,
  // });
  ...
  return (
    <>
          ...
          <div className='flex flex-col items-center space-y-4 md:flex-row md:justify-between'>
            ...
            <div className='flex flex-col space-y-2 md:flex-row md:space-x-4 md:space-y-0'>
              <Button
                ...
                onClick={() => toggleView(ViewType.CreateExpenseAccount)}
              >
              ...
              <Button
                variant='default'
                className='w-full bg-emerald-600 hover:bg-emerald-700 md:w-auto'
                onClick={() => toggleView(ViewType.LoginExpense)}
              >
                Log In New Expense
              </Button>
            </div>
      ...
      {(() => {
        switch (currentView) {
          case ViewType.CreateExpenseAccount:
            return <NewExpenseAccountForm handleCreate={handleCreate} />;
          case ViewType.LoginExpense:
            return <PaymentForm
             sourceType="account"
             onSuccess={handleCreate} 
             onCancel={() => toggleView(ViewType.Default)}
             />;
          default:
            return null;
        }
