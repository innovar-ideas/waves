...
export default function FeedbackChatPage() {
  ...
  const markAsResolved = trpc.markFeedbackAsResolved.useMutation();
      ...
      <div className=" bg-white shadow-sm px-4 py-2 m-4 rounded-xl flex flex-col h-[calc(70vh-65px)] ">
        <div className="flex items-center justify-between border-b pb-2">
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-semibold">{chat?.name || "Feedback Chat"}</h2>
          </div>
          <Button onClick={handleMarkAsResolved} disabled={markAsResolved.isPending}>
            Mark as Resolved
          </Button>
        </div>
