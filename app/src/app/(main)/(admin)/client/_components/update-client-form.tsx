...
interface UpdateClientFormProps {
  client: Client & {addresses: Address[]}
  onSuccess?: () => void
};
...
export function UpdateClientForm({ client, onSuccess }: UpdateClientFormProps) {
  ...
  const formattedAddress = client.addresses.map(item => ({
    ...item,
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Update client information. Click save when you&apos;re done.</DialogDescription>
        </DialogHeader>
