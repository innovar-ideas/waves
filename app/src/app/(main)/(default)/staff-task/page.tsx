...
// import { TaskForm, TaskTable } from "@/app/server/types";
...
//       try {
//         const {data: taskData} = trpc.staffGetTaskById.useQuery({ id: params.id as string });
//         setTask(taskData);
//         setLoading(false);
//       } catch (error) {
...
//                   <Checkbox
//                     id={option}
//                     checked={form.form_value === option}
//                     onCheckedChange={(checked) => {
//                       if (checked) {
//                         setFormData(formData.map(f => 
//                           f === form ? {...f, form_value: option} : f
//                         ));
//                       }
//                     }}
//                   />
...
//             {task.instructions?.instruction_type === "form" && (
//               <form onSubmit={handleFormSubmit} className="space-y-6">
//                 {task.instructions.form.map((field: FormField, index: number) => (
//                   <div key={index} className="space-y-4">
//                     {renderFormField(field as unknown as )}
//                   </div>
//                 ))}
...
//                 <p className="text-gray-600">{task.instructions.instruction_content}</p>
