...
export const pageRoleMapping = {
  ...
  admin: [pages.admin_dashboard, pages.staffs, pages.contracts, pages.payrolls, pages.teams, pages.designation, pages.leave_application_settings, pages.manage_leave_application, pages.loan_settings, pages.manage_loan, pages.loan_repayment, pages.organization, pages.admins, pages.performance_review_template, pages.performance_review, pages.policies_and_procedures, pages.admin_notification, pages.communication, pages.settings],
  employee: [pages.profile, pages.loan, pages.leave, pages.payslip, pages.settings, pages.admin_notification],
